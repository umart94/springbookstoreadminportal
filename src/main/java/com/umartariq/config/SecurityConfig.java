...
import com.umartariq.service.impl.UserSecurityService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHERS = { "/css/**", "/js/**", "/images/**", "/", "/newUser",
			"/resetPassword", "/login", "/fonts/**","/webfonts/**" };
